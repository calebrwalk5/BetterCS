...
void updateClantag() {
    if ((TICKCOUNTWITHPING() % 128) > 96) {
        Offsets::sendClantag(Menu::clantag, "UC/anvsO1\xe2\x80\xa8\xe2\x80\xa8\xe2\x80\xa8");
    }
    else {
        Offsets::sendClantag(Menu::clantag, "BetterCS\xe2\x80\xa8\xe2\x80\xa8\xe2\x80\xa8");
    }
}
