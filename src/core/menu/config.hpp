...
namespace Config {
    ...
    inline char configFileName[128] = "N3WTuX.cfg";
    ...
    inline std::unordered_map<std::string_view, ConfigItem> config {
        ...
        // Misc {
            ...
            CONFIGITEM("Misc>Misc>Movement>Block Bot", false),
            CONFIGITEM("Misc>Misc>Movement>Block Bot Key", 0),
