...
void style() {
    ...
    colors[ImGuiCol_WindowBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.51f);
    colors[ImGuiCol_ChildBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_PopupBg] = ImVec4(0.08f, 0.08f, 0.08f, 0.94f);
    colors[ImGuiCol_Border] = ImVec4(0.24f, 0.24f, 0.24f, 0.50f);
    colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_FrameBg] = ImVec4(0.6f, 0.6f, 0.6f, 1.00f);
    ...
    colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f);
    colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f);
    colors[ImGuiCol_Button] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_ButtonActive] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_Header] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_HeaderActive] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_Separator] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_SeparatorHovered] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_SeparatorActive] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_ResizeGrip] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_ResizeGripActive] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_Tab] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_TabHovered] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_TabActive] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    colors[ImGuiCol_TabUnfocused] = ImVec4(0.071f, 0.600f, 0.600f, 1.00f); 
    ...
    void Menu::drawMenu() {
      ...
      ImGui::GetStyle().Colors[ImGuiCol_Button] = (Menu::tabSelected == 1) ? ImVec4(0.444f, 0.600f, 1.000f, 1.00f) : ImVec4(0.44313725490196076f, 0.5647058823529412f, 0.6f, 1.0f);
      ...
      if (ImGui::Button("Anti Aim", bWidth)) {
        Menu::tabSelected = 5;
      }
